...
void tpce_worker::DoTradeOrderFrame1(const TTradeOrderFrame1Input *pIn,
				       TTradeOrderFrame1Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeOrderDB::DoTradeOrderFrame1"<<endl;
...
void tpce_worker::DoTradeOrderFrame2(const TTradeOrderFrame2Input *pIn,
				       TTradeOrderFrame2Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeOrderDB::DoTradeOrderFrame2"<<endl;
...
void tpce_worker::DoTradeOrderFrame3(const TTradeOrderFrame3Input *pIn,
				       TTradeOrderFrame3Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeOrderDB::DoTradeOrderFrame3"<<endl;
...
void tpce_worker::DoTradeOrderFrame4(const TTradeOrderFrame4Input *pIn,
				       TTradeOrderFrame4Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeOrderDB::DoTradeOrderFrame4"<<endl;
...
void tpce_worker::DoTradeOrderFrame5(TTradeOrderFrame5Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeOrderDB::DoTradeOrderFrame5"<<endl;
#endif
...
void tpce_worker::DoTradeOrderFrame6(TTradeOrderFrame6Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeOrderDB::DoTradeOrderFrame6"<<endl;
#endif
