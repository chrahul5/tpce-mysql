...
void tpce_worker::DoTradeUpdateFrame1(const TTradeUpdateFrame1Input *pIn,
					 TTradeUpdateFrame1Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeUpdateDB::DoTradeUpdateFrame1"<<endl;
...
void tpce_worker::DoTradeUpdateFrame2(const TTradeUpdateFrame2Input *pIn,
					 TTradeUpdateFrame2Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeUpdateDB::DoTradeUpdateFrame2"<<endl;
...
void tpce_worker::DoTradeUpdateFrame3(const TTradeUpdateFrame3Input *pIn,
					 TTradeUpdateFrame3Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeUpdateDB::DoTradeUpdateFrame3"<<endl;
