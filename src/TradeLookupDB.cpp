...
void tpce_worker::DoTradeLookupFrame1(const TTradeLookupFrame1Input *pIn,
					 TTradeLookupFrame1Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeLookupDB::DoTradeLookupFrame1"<<endl;
...
void tpce_worker::DoTradeLookupFrame2(const TTradeLookupFrame2Input *pIn,
					 TTradeLookupFrame2Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeLookupDB::DoTradeLookupFrame2"<<endl;
...
void tpce_worker::DoTradeLookupFrame3(const TTradeLookupFrame3Input *pIn,
					 TTradeLookupFrame3Output *pOut)
{
#ifdef DEBUG
    cout<<"CTradeLookupDB::DoTradeLookupFrame3"<<endl;
...
void tpce_worker::DoTradeLookupFrame4(const TTradeLookupFrame4Input *pIn,
					 TTradeLookupFrame4Output *pOut)
{
    int i;
#ifdef DEBUG
